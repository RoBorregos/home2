...
class AECTester(Node):
    def __init__(self):
        ...
        self.create_subscription(AudioData, '/rawAudioChunk', self.raw_audio_callback, 10)
        self.create_subscription(AudioData, '/cleanAudioChunk', self.clean_audio_callback, 10)
        self.create_subscription(AudioData, '/farAudioChunk', self.far_audio_callback, 10)
        self.create_subscription(String, '/speech/oww', self.wakeword_callback, 10)
        self.create_subscription(String, '/speech/interrupt', self.interrupt_callback, 10)
    ...
    def report_status(self):
        ...
        self.get_logger().info(f"Estado del speaker: {'Hablando' if self.is_speaking else 'Silencio'}")
...
def main(args=None):
    ...
    def run_tests():
        ...
        tester.get_logger().info("Prueba 3: Di 'frida' para probar detección de wake word...")
