...
class EventsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Listen = channel.stream_stream(
                '/events.EventsService/Listen',
                request_serializer=events__pb2.AudioRequest.SerializeToString,
                response_deserializer=events__pb2.TextResponse.FromString,
...
def add_EventsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Listen': grpc.stream_stream_rpc_method_handler(
                    servicer.Listen,
                    request_deserializer=events__pb2.AudioRequest.FromString,
                    response_serializer=events__pb2.TextResponse.SerializeToString,
            ),
    }
...
class EventsService(object):
    ...
    def Listen(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/events.EventsService/Listen',
            events__pb2.AudioRequest.SerializeToString,
            events__pb2.TextResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
