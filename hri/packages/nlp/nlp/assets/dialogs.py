    ...
    return [
        {
            "role": "system",
            "content": (
                f"You will be given a question. Your task is to clean it in a way of question format. The question is: {question}",
                "Return a question, ignore unecessary or irrelevant details to the question. ",
            ),
        },
        {
            "role": "user",
