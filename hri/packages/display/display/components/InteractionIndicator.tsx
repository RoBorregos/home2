...
export function AudioStateIndicator() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/5 pointer-events-none -translate-y-40">
      <div className="relative">
        ...
        <div className="relative z-10 h-48 w-48 rounded-full bg-(--pulse) shadow-lg flex items-center justify-center">
          <Mic className="h-32 w-32 text-white/90 drop-shadow-md" />
        </div>
