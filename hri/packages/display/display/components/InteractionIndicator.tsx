  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/5 pointer-events-none -translate-y-8 md:-translate-y-12 transition-transform duration-300">
      <div className="relative">
        ...
        <div className="relative z-10 h-14 w-14 md:h-28 md:w-28 rounded-full bg-(--pulse) shadow-lg flex items-center justify-center transition-all duration-300">
          <Mic className="h-7 w-7 md:h-16 md:w-16 text-white/90 drop-shadow-md transition-all duration-300" />
        </div>
