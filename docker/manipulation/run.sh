...
COLCON="colcon build --symlink-install --packages-up-to manipulation_general xarm6_ikfast_plugin xarm_utils frida_description --packages-ignore realsense_gazebo_plugin xarm_gazebo frida_interfaces"
