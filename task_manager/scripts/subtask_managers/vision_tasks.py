...
class VisionTasks:
    ...
    def __init__(self, task_manager, task: Task, mock_data=False) -> None:
        ...
        self.beverage_location_client = self.node.create_client(
            BeverageLocation, BEVERAGE_TOPIC
        )
        ...
        self.services = {
            Task.RECEPTIONIST: {
                ...
                "person_description": {
                    "client": self.person_description_client,
                    "type": "service",
                },
                "beverage_location": {
                    "client": self.beverage_location_client,
                    "type": "service",
                },
                "follow_by_name": {
                    "client": self.follow_by_name_client,
                    "type": "service",
                },
            },
        }
