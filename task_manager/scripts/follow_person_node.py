...
"""
Follow person node that allows the arm to rotate while following the person pose
"""
...
class FollowFaceNode(Node):
    ...
    def __init__(self):
        ...
        self.dashgo_cmd_vel_sub = self.create_subscription(
            PoseStamped, DASHGO_CMD_VEL_TOPIC, self.follow_callback, 10
        )
