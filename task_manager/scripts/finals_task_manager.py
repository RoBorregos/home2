...
class FINALS_TM(Node):
    ...
    def __init__(self):
        ...
        self.LOCATION_TO_CATEGORY = {
            ("laundry", "table"): "fabric",
            ("laundry", "shelf"): "snack",
            ("bedroom", "bed"): "toy",
            ("living_room", "coffee_table"): "food",
            ("kitchen", "cabinet"): "drink",
            ("kitchen", "cooking_table"): "cleaning_supply",
            ("kitchen", "dinner_table"): "fruit",
            ("kitchen", "dishwasher"): "dish",
        }

        self.CATEGORY_TO_LOCATION = {
            "fabric": ("laundry", "table"),
            "snack": ("laundry", "shelf"),
            "toy": ("bedroom", "bed"),
            "food": ("living_room", "coffee_table"),
            "drink": ("kitchen", "cabinet"),
            "cleaning_supply": ("kitchen", "cooking_table"),
            "fruit": ("kitchen", "dinner_table"),
        ...
        self.PLACEMENT_LOCATIONS = [
            ...
            ("living_room", "sofa"),
            ("living_room", "coffee_table"),
            ("kitchen", "cabinet"),
            ("kitchen", "counter"),
            ("kitchen", "cooking_table"),
