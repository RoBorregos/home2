...
class TestPlaceCloseByTrashWorkflow(Node):
    ...
    def run_workflow(self):
        ...
        if result == Status.EXECUTION_SUCCESS:
            self.get_logger().info("✓ Successfully placed object on top of trash_can (using already-detected trash)")
        else:
            ...
            self.get_logger().info("✓ Successfully placed object on top of trash_can (after explicit detection)")
