...
- ros2 run frida_pymoveit2 ex_joint_goal.py --ros-args -p joint_positions:="[1.57, -1.57, -1.57, 0.0, 1.57, 0.7854]" -p synchronous:=False -p cancel_after_secs:=1.0
- ros2 run frida_pymoveit2 ex_joint_goal.py --ros-args -p joint_positions:="[1.57, -1.57, -1.57, 0.0, 1.57, 0.7854]" -p synchronous:=False -p cancel_after_secs:=0.0
- ros2 run frida_pymoveit2 ex_joint_goal.py --ros-args -p joint_positions:="[1.57, -1.57, -1.57, 0.0, 1.57, 0.7854]"
"""
