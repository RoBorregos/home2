...
public:
  DownSamplePointCloud() : Node("downsample_pointcloud") {
    ...
    this->input_topic = this->declare_parameter(
        "PointCloudTopic", "/zed/zed_node/point_cloud/cloud_registered");

    this->output_topic =
        this->declare_parameter("OutputPointCloudTopic", "/point_cloud");
