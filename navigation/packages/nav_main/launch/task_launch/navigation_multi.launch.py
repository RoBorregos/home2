...
def generate_launch_description():
    ...
    rtabmapnav = IncludeLaunchDescription(
        ...
        launch_arguments={'localization': localization, 'rtab_config_file': rtab_params, 'nav2': 'false', 'map_name': rtabmap_map_name}.items(),
        )
    nav2 = IncludeLaunchDescription(
        ...
        launch_arguments={'nav2_config_file': nav2_params, 'use_docking': docking}.items(),
